...
public class MainTopicAdapter extends RecyclerView.Adapter<MainTopicAdapter.TopicViewHolder> implements
    ...
    @Override
    public void onBindViewHolder(@NonNull MainTopicAdapter.TopicViewHolder holder,int pos) {
    ...
    @Override
    public void onSwipeItemStarted(@NonNull TopicViewHolder holder, int position) {
    ...
    protected class TopicViewHolder extends AbstractSwipeableItemViewHolder implements DraggableItemViewHolder {
        ...
        protected TopicViewHolder(View rootView) {
            super(rootView);
            this.RL_topic_content = rootView.findViewById(R.id.RL_topic_content);
            this.IV_topic_icon = rootView.findViewById(R.id.IV_topic_icon);
            this.TV_topic_title = rootView.findViewById(R.id.TV_topic_title);
            this.TV_topic_count = rootView.findViewById(R.id.TV_topic_count);
            this.IV_topic_arrow_right = rootView.findViewById(R.id.IV_topic_arrow_right);

            //Left setting view
            this.RL_topic_view = rootView.findViewById(R.id.RL_topic_view);
            this.LL_topic_left_setting = rootView.findViewById(R.id.LL_topic_left_setting);
            this.IV_topic_left_setting_edit = rootView.findViewById(R.id.IV_topic_left_setting_edit);
            this.IV_topic_left_setting_delete = rootView.findViewById(R.id.IV_topic_left_setting_delete);
