...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LL_main_profile = findViewById(R.id.LL_main_profile);
        ...
        EDT_main_topic_search = findViewById(R.id.EDT_main_topic_search);
    ...
    @Override
    public void TopicCreated(String topicTitle, int type, int color) {
        dbManager.openDB();
