...
public class EntriesAdapter extends RecyclerView.Adapter<EntriesAdapter.EntriesViewHolder> {
    ...
    protected class EntriesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        protected EntriesViewHolder(View rootView, @ColorInt int color) {
            super(rootView);
            this.TV_entries_item_header = rootView.findViewById(R.id.TV_entries_item_header);

            this.TV_entries_item_date = rootView.findViewById(R.id.TV_entries_item_date);
            this.TV_entries_item_day = rootView.findViewById(R.id.TV_entries_item_day);
            this.TV_entries_item_time = rootView.findViewById(R.id.TV_entries_item_time);
            this.TV_entries_item_title = rootView.findViewById(R.id.TV_entries_item_title);
            this.TV_entries_item_summary = rootView.findViewById(R.id.TV_entries_item_summary);

            this.IV_entries_item_weather = rootView.findViewById(R.id.IV_entries_item_weather);
            this.IV_entries_item_mood = rootView.findViewById(R.id.IV_entries_item_mood);
            this.IV_entries_item_bookmark = rootView.findViewById(R.id.IV_entries_item_bookmark);
            this.IV_entries_item_attachment = rootView.findViewById(R.id.IV_entries_item_attachment);

            this.RL_entries_item_content = rootView.findViewById(R.id.RL_entries_item_content);
